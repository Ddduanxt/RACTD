...
class DiffusionUnetLowdimD4RLRewardPolicy(BaseLowdimPolicy):
    def __init__(self, 
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        assert 'observations' in obs_dict
    ...
    def compute_loss(self, batch):
        ...
        obs = self.normalizer['observations'].normalize(batch['observations'])
        ...
        total_loss["mse"] = loss * self.losses["mse"]


        ### Loss for reward optimization
        nobs_features = obs[:,self.n_obs_steps-1,...]
        ...
        total_loss["rwd"] = reward_loss * self.losses["rwd"]
