...
from consistency_policy.student_lowdim.ctm_policy_lowdim import CTMPUnetLowdimPolicy
...
class CTMLowdimWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: CTMPUnetLowdimPolicy = hydra.utils.instantiate(cfg.policy)
