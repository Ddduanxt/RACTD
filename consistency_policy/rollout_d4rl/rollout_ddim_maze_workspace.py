...
class DDIMRolloutMazeWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetLowdimMazePolicy = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetLowdimMazePolicy = None
...
def main(cfg):
    workspace = DDIMRolloutMazeWorkspace(cfg)
    workspace.run()
