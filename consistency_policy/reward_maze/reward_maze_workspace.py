...
import numpy as np
import shutil
from consistency_policy.reward_maze.reward_maze_policy import DiffusionUnetMazeReward
...
class TrainMazeRewardWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        # configure model
        self.model: DiffusionUnetMazeReward = hydra.utils.instantiate(cfg.policy)

        self.ema_model: DiffusionUnetMazeReward = None
...
def main(cfg):
    workspace = TrainMazeRewardWorkspace(cfg)
    workspace.run()
