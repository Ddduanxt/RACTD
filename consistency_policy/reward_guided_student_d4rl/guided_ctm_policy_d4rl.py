...
class GuidedCTMPUnetD4RLPolicy(BaseLowdimPolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        reward_input_dim = action_dim + obs_dim
        reward = ValueUnet1D(
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.use_kde and B == 1:
            ...
            action_pred = self.normalizer['actions'].unnormalize(naction_pred).cpu().numpy()
    ...
    def compute_loss(self, batch):
        ...
        if "rwd" in self.losses.keys():
            ...
            pred_action = pred[:,self.n_obs_steps-1, :]
