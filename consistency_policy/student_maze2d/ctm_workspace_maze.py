...
from consistency_policy.student_maze2d.ctm_policy_maze import CTMPUnetMazePolicy
...
class CTMMazeWorkspace(BaseWorkspace):
    ...
    def __init__(self, cfg: OmegaConf, output_dir=None):
        ...
        self.model: CTMPUnetMazePolicy = hydra.utils.instantiate(cfg.policy)
...
def main(cfg):
    workspace = CTMMazeWorkspace(cfg)
    workspace.run()
